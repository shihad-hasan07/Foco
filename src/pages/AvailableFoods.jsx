        ...
        <div>
            <div className='container my-10 mx-auto flex justify-between items-center'>
                ...
                <div className='flex gap-5'>
                    ...
                    {/* column toogle btn */}
                    <button onClick={toogleColumn} className='hidden lg:flex items-center border px-6 rounded-xl border-[#17c3b2]'> <span className='text-2xl pr-6'>Change column</span> {column2 ? <TfiLayoutColumn3 size={32} /> : <TfiLayoutColumn2 size={32} />}</button>
                </div>
            </div>
