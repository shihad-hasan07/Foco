            ...
            <div className=''>
                ...
                <div className='flex  gap-10 justify-between bg-blue-100 rounded-b-xl p-5'>
                    ...
                    <div>
                        ...
                        <p className='text-xl my-3 font-medium'>ExpireDate : {formatDate(ExpiredDateTime)}</p>
                        <div><span className='px-3 text-sm text-white py-1 rounded-3xl bg-blue-900'>{FoodStatus}</span></div>

                        {/* donator details ---- show --> md == hidden */}
                        <div className='block md:hidden mt-3 pr-10 min-w-80'>
                            <p className='font-semibold'>Donator :{Donator?.Name}</p>
                            <p className='font-semibold mt-2'>Email :{Donator?.Email}</p>
                        </div>

                        <button className='primaryBtn mt-5' onClick={() => addtoFoodReqest(_id)}>Request</button>
                    </div>

                    {/* donator details ---- hidden --> md == show */}
                    <div className='hidden md:block pr-10 min-w-80'>
                        <p className='font-semibold'>Donator :{Donator?.Name}</p>
                ...
                <dialog id="my_modal_1" className="modal">
                    <div className="modal-box w-96 md:w-full py-16 bg-add-food-bg bg-no-repeat bg-cover">
                            ...
                            <div className="container mx-auto text-center text-gray-500">
                                ...
                                <div className="mb-6">
                                    <input type="" name="ExpiredDateTime" value={foodRequest.RequestDateTime} disabled
                                        className="py-3 border px-[38px] rounded bg-black" />
                                </div>
